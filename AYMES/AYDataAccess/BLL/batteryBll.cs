...
namespace AYDataAccess
{
	...
	{
		private readonly batteryDal dal=new batteryDal();
        public batteryBll()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<batteryModel> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<batteryModel> DataTableToList(DataTable dt)
		{
			List<batteryModel> modelList = new List<batteryModel>();
