...
namespace AYDataAccess
{
	...
	public partial class propertyDal
	{
        ...
        public bool Add(propertyModel model)
        {
            ...
            strSql.Append("propertyID,propertyName,propertyCata,tag1,tag2,tag3,tag4,tag5)");
        ...
        public bool Update(propertyModel model)
        {
            ...
            parameters[1].Value = model.propertyCata;
        ...
        public propertyModel GetModel(string propertyID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 propertyID,propertyName,propertyCata,tag1,tag2,tag3,tag4,tag5 from property ");
            strSql.Append(" where propertyID=@propertyID ");
            SqlParameter[] parameters = {
					new SqlParameter("@propertyID", SqlDbType.NVarChar,50)			};
            parameters[0].Value = propertyID;
        ...
        /// 得到一个对象实体
        /// </summary>
        public propertyModel DataRowToModel(DataRow row)
        {
            propertyModel model = new propertyModel();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select propertyID,propertyName,propertyCata,tag1,tag2,tag3,tag4,tag5 ");
