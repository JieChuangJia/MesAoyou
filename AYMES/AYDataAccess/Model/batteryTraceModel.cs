...
{
	/// <summary>
    /// batteryTraceModel:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class batteryTraceModel
	{
        public batteryTraceModel()
		{}
		#region Model
		private string _batterytraceid;
		...
		/// 
		/// </summary>
		public string batteryTraceID
		{
			set{ _batterytraceid=value;}
			get{return _batterytraceid;}
		}
		/// <summary>
		/// 
		/// </summary>
